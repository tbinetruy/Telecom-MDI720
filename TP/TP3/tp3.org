...
#+BEGIN_SRC python :session default :exports both :results output
  ...
  def fast_forward_selection(X_train, Y_train, stop):
    p = X_train.shape[1]
    n = X_train.shape[0]
    res_prev = Y_train
    X = get_X(X_train)
...
#+RESULTS:
: Ordre de selection des variables: [0, 59, 124, 168, 24, 35, 175, 100]
...
#+RESULTS:
: [0, 59, 124, 168, 24, 175, 35, 100, 8, 95, 134, 104, 28, 116, 18, 113, 93, 198, 149, 163, 129, 122, 147, 80, 34, 111, 23, 20, 19, 46, 61, 183, 85, 169, 208, 44, 82, 159, 50, 87, 54, 178, 5, 12, 160, 45, 86, 189, 139, 96, 161, 51, 144, 117, 89, 30, 148, 137, 77, 143, 14, 209, 56, 130, 21, 196, 179, 184, 63, 10, 4, 48, 132, 36, 109, 154, 101, 176, 180, 73, 151, 150, 29, 17, 103, 170, 107, 76, 162, 192, 167, 6, 120, 98, 186, 62, 91, 115, 106, 79, 210, 110, 66, 187, 75, 121, 42, 25, 94, 92, 177, 173, 3, 78, 153, 131, 83, 60, 135]
